...
| [`packages/vantio-agent-sdk-py`](./packages/vantio-agent-sdk-py) | `vantio-agent-sdk` **3.0.12** | Python wrap — urllib + http.client + optional requests/httpx/aiohttp/urllib3/pycurl + socket.connect + subprocess curl/wget |
