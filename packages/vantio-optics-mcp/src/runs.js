...
export function proveMarkdown(log) {
  ...
  return [
    ...
    "## Residual (honest)",
    "",
    "Optics fills your data log on the attach path. Ungoverned paths (curl, raw sockets, unwrapped processes) stay silent. Upgrade to **Vantio Gate** to apply the rules you set, then **Vantio Phantom Engine** when you need protection on Linux machines you own.",
    "",
...
export const UPGRADE_PATH = {
  ...
  next: [
    ...
    },
    {
      ...
      unlocks: "Protect machines you own — enforce and control together; Rogue Reconciliation (patent pending)",
