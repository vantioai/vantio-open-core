...
This patch corrects PyPI project URLs and long-description product model: Optics (free), Phantom Engine ($799/node/mo — Observe, Enforce, and Control), Enterprise (talk to sales). No Gate $499, Gate Pro, hosted Gate, or four-product ladder. SDK behavior is unchanged from 3.0.13.
