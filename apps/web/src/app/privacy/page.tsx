  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-24">
      ...
      {[
        ...
        { h: "4. Data Sharing", body: "We do not sell your data. We share data with: Stripe (payment processing), Supabase (database hosting, SOC 2 Type II certified), Google Cloud (Spanner WORM ledger for Tier 03), and Vercel (web app & API hosting). Each sub-processor is contractually bound to process data only as instructed by Vantio AI, Inc." },
