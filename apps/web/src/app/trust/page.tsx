...
export const metadata: Metadata = buildMetadata({
  ...
  description: "How Vantio protects your data — we never read your prompts, your Enterprise records stay in your cloud, and every decision is in a tamper-proof audit ledger.",
  path: "/trust",
});
...
export default function TrustPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-24">
      ...
      <h1 className="mb-4 text-4xl font-bold">How we protect your data.</h1>
      <p className="mb-16 text-[var(--muted)]">
        Vantio is built for regulated industries. Here&apos;s exactly how we protect your data
        and how our architecture maps to the compliance requirements your team cares about.
      </p>

      {/* Key assurances */}
      <div className="mb-16 grid gap-5 sm:grid-cols-2">
        {[
          { icon: "🚫", title: "We never read your prompts", body: "Vantio records that an action happened — not what was said. The content of your AI conversations never reaches us. Your sensitive data stays yours." },
          { icon: "🔒", title: "Your data never leaves your cloud (Enterprise)", body: "Enterprise runs entirely inside your own cloud. Your audit records stay in your own database — we have no access to them." },
          { icon: "📋", title: "Tamper-proof audit records", body: "Every Vantio decision is sealed into a ledger that can't be edited or deleted — not even by us. It's there, verifiable, when an auditor asks." },
      ...
      <div className="mb-16 rounded-xl border border-[var(--border)] bg-[var(--surface)] p-6">
        ...
        <p className="text-sm text-[var(--muted)]">
          ...
          install ID, SDK/CLI version, runtime, OS, and aggregate call/redaction/block counts. No
          prompt or completion content is ever stored. Telemetry carries no API key, email, or IP
          address, and cross-tenant benchmarks contain no tenant identifiers. Opt out any time with{" "}
      ...
      <p className="mb-6 text-sm text-[var(--muted)]">
        Vantio AI, Inc. is a registered Delaware C-Corporation structured for Fortune 500 procurement and
        vendor risk requirements. The items below describe how Vantio&apos;s architecture is designed and
        aligned — they are engineering and readiness signals, not claims of completed third-party certification.
      </p>
